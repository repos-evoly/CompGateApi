...
namespace CompGateApi.Data.Seeding
{
    public class DataSeeder
    {
        ...
        private void SeedPricings()
        {
            ...
            var desired = new[]
            {
        new { TrxCatName = "Checkbook",             PctAmt = (decimal?)null, Price = (decimal?)20.0000m, Desc = (string?)"CheckBook - 24 leaves", GL1 = (string?)"0012111273001", GL2 = (string?)null, GL3 = (string?)null, GL4 = (string?)null, DTC = (string?)"044", CTC = (string?)"900", DTC2 = (string?)null, CTC2 = (string?)null, NR2 = (string?)null, APPLYTR2 = false, Unit = 24, AmountRule = (string?)null },
        new { TrxCatName = "Checkbook",             PctAmt = (decimal?)null, Price = (decimal?)40.0000m, Desc = (string?)"CheckBook - 48 leaves", GL1 = (string?)"0012111273001", GL2 = (string?)null, GL3 = (string?)null, GL4 = (string?)null, DTC = (string?)"044", CTC = (string?)"900", DTC2 = (string?)null, CTC2 = (string?)null, NR2 = (string?)null, APPLYTR2 = false, Unit = 48, AmountRule = (string?)null },
        new { TrxCatName = "CheckRequest",          PctAmt = (decimal?)null, Price = (decimal?)null,      Desc = (string?)"Check Request (per cheque amount)", GL1 = (string?)"{BRANCH}831892434", GL2 = (string?)null, GL3 = (string?)null, GL4 = (string?)null, DTC = (string?)"044", CTC = (string?)"900", DTC2 = (string?)null, CTC2 = (string?)null, NR2 = (string?)"Check request", APPLYTR2 = false, Unit = 1, AmountRule = (string?)"amount" },
        new { TrxCatName = "VisaRequest",           PctAmt = (decimal?)null, Price = (decimal?)null,      Desc = (string?)"Visa Request ", GL1 = (string?)"0012111273001", GL2 = (string?)null, GL3 = (string?)null, GL4 = (string?)null, DTC = (string?)"044", CTC = (string?)"900", DTC2 = (string?)null, CTC2 = (string?)null, NR2 = (string?)null, APPLYTR2 = false, Unit = 1, AmountRule = (string?)"amount" },
        new { TrxCatName = "CertifiedBankStatement",PctAmt = (decimal?)null, Price = (decimal?)1.0000m,   Desc = (string?)"Certified Bank Statement", GL1 = (string?)"0010932700434", GL2 = (string?)null, GL3 = (string?)null, GL4 = (string?)null, DTC = (string?)"044", CTC = (string?)"900", DTC2 = (string?)null, CTC2 = (string?)null, NR2 = (string?)null, APPLYTR2 = false, Unit = 31, AmountRule = (string?)null },
        new { TrxCatName = "Rtgs",                  PctAmt = (decimal?)null, Price = (decimal?)0.0000m,   Desc = (string?)null, GL1 = (string?)"{BRANCH}12111273001", GL2 = (string?)null, GL3 = (string?)null, GL4 = (string?)null, DTC = (string?)"", CTC = (string?)"", DTC2 = (string?)"", CTC2 = (string?)"", NR2 = (string?)"RTGS transfer", APPLYTR2 = false, Unit = 1, AmountRule = (string?)null },
        new { TrxCatName = "Salary Payment",        PctAmt = (decimal?)0.0000m, Price = (decimal?)5.0000m,Desc = (string?)"Salary", GL1 = (string?)"0010932702434", GL2 = (string?)null, GL3 = (string?)null, GL4 = (string?)null, DTC = (string?)null, CTC = (string?)null, DTC2 = (string?)null, CTC2 = (string?)null, NR2 = (string?)"Salary ", APPLYTR2 = false, Unit = 1, AmountRule = (string?)null },
    }
