...
namespace CompGateApi.Data.Migrations
{
    ...
    [Migration("20260617095340_WalletSalaryStoreForward")]
    partial class WalletSalaryStoreForward
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalaryEntryAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SalaryEntryAllocations", (string)null);
                });

            modelBuilder.Entity("SalaryWalletBatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CoreReferenceId")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.Property<decimal>("FailedTotalAmount")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");
                    ...
                    b.Property<string>("ReversalBankReference")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<string>("ReversalErrorMessage")
                        .HasMaxLength(1024)
                        .HasColumnType("nvarchar(1024)");

                    b.Property<string>("ReversalRequestJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("ReversalRequired")
                        .HasColumnType("bit");

                    b.Property<string>("ReversalResponseJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ShadowAccount")
                        .IsRequired()
                        .HasMaxLength(34)
                        .HasColumnType("nvarchar(34)");

                    b.Property<decimal>("SuccessfulTotalAmount")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");
                    ...
                    b.Property<string>("WalletChannel")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.HasIndex("ReconciliationStatus", "NextAttemptAt");

                    b.ToTable("SalaryWalletBatches", (string)null);
                });

            modelBuilder.Entity("SalaryWalletBatchAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SalaryWalletBatchId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SalaryWalletBatchId");

                    b.ToTable("SalaryWalletBatchAttempts", (string)null);
                });

            modelBuilder.Entity("SalaryWalletManualReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("UnresolvedAmount")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");
                    ...
                    b.ToTable("SalaryWalletManualReviews", (string)null);
                });
            ...
            modelBuilder.Entity("SalaryEntryAllocation", b =>
                {
                    b.HasOne("SalaryEntry", "SalaryEntry")
            ...
            modelBuilder.Entity("SalaryWalletBatchAttempt", b =>
                {
                    b.HasOne("SalaryWalletBatch", "SalaryWalletBatch")
                        .WithMany("Attempts")
                        .HasForeignKey("SalaryWalletBatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SalaryWalletBatch");
                });
