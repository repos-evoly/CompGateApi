...
namespace CompGateApi.Data.Migrations
{
    ...
    [Migration("20260817121703_MobileNotificationOutbox")]
    partial class MobileNotificationOutbox
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompGateApi.Data.Models.LyPayTransfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DhbReference")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<DateTimeOffset?>("ExecutionClaimedAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<string>("FromAccountPhoneNo")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<DateTimeOffset?>("NextStatusCheckAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<string>("ProviderReturnMessageCode")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<DateTimeOffset?>("StatusCheckClaimedAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<string>("ToInstitutionId")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("ToInstitutionName")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.HasIndex("Status", "NextStatusCheckAt");

                    b.HasIndex("CompanyId", "Status", "NextStatusCheckAt");

                    b.ToTable("LyPayTransfers", (string)null);
                });

            modelBuilder.Entity("CompGateApi.Data.Models.LyPayValidationSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CompanyId", "CreatedByUserId", "ExpiresAt");

                    b.ToTable("LyPayValidationSessions", (string)null);
                });

            modelBuilder.Entity("CompGateApi.Data.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ToAuthUserId", "CreatedAt");

                    b.HasIndex("ToAuthUserId", "ReadAt");

                    b.ToTable("Notifications");
                });

            modelBuilder.Entity("CompGateApi.Data.Models.NotificationOutbox", b =>
                {
                    b.Property<Guid>("EventId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("RecipientAuthUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompletedAt", "DeadLetteredAt", "AvailableAt", "LeaseExpiresAt");

                    b.ToTable("NotificationOutbox");
                });

            modelBuilder.Entity("CompGateApi.Data.Models.OnePayTransfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OnePayTransfers", (string)null);
                });

            modelBuilder.Entity("CompGateApi.Data.Models.OnePayValidationSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OnePayValidationSessions", (string)null);
                });
            ...
            modelBuilder.Entity("CompGateApi.Data.Models.ServicePackageDetail", b =>
                {
                    ...
                    b.Property<decimal?>("B2BFixedFeeForeign")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal?>("B2CFixedFeeForeign")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("CompGateApi.Data.Models.Notification", b =>
                {
                    b.HasOne("CompGateApi.Data.Models.User", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("CompGateApi.Data.Models.User", "ToUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CompGateApi.Data.Models.NotificationOutbox", b =>
                {
                    b.HasOne("CompGateApi.Data.Models.Notification", "Notification")
                        .WithOne("Outbox")
                        .HasForeignKey("CompGateApi.Data.Models.NotificationOutbox", "NotificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
